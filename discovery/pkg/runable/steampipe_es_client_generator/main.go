...
import (
	...
	"flag"
	"fmt"
	"github.com/opengovern/og-describer-azure/discovery/pkg/runable/steampipe_es_client_generator/detector"
	...
	ast.Inspect(node, func(n ast.Node) bool {
		...
		for _, spec := range decl.Specs {
			...
			if decl.Doc != nil {
				...
				s.GetFilters["platform_integration_id"] = "integration_id"
				s.ListFilters["platform_integration_id"] = "integration_id"
