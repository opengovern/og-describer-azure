...
func tableAzureAdManagedIdentity(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: azureKaytuColumns([]*plugin.Column{
			...
			{Name: "identity_type", Type: proto.ColumnType_STRING, Description: "Identifies whether the Managed Identity is SystemAssigned or UserAssigned", Transform: transform.FromField("Description.IdentityType")},
			...
			{Name: "tags", Type: proto.ColumnType_JSON, Description: ColumnDescriptionTags, Transform: transform.From(adManagedIdentityTags)},
			{Name: "title", Type: proto.ColumnType_STRING, Description: ColumnDescriptionTitle, Transform: transform.From(adManagedIdentityTitle)},
