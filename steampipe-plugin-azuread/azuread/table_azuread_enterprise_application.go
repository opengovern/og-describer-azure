...
func tableAzureAdEnterpriseApplication(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: azureKaytuColumns([]*plugin.Column{
			...
			{Name: "tags", Type: proto.ColumnType_JSON, Description: ColumnDescriptionTags, Transform: transform.From(adEnterpriseApplicationTags)},
			{Name: "title", Type: proto.ColumnType_STRING, Description: ColumnDescriptionTitle, Transform: transform.From(adEnterpriseApplicationTitle)},
