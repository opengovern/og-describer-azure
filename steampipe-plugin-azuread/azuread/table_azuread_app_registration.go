...
func tableAzureAdAppRegistration(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: azureKaytuColumns([]*plugin.Column{
			...
			// Standard columns
			{Name: "tags", Type: proto.ColumnType_JSON, Description: ColumnDescriptionTags, Transform: transform.From(adAppRegistrationTags)},
			{Name: "title", Type: proto.ColumnType_STRING, Description: ColumnDescriptionTitle, Transform: transform.From(adAppRegistrationTitle)},
