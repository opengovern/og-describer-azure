...
func tableAzureNetworkPrivateDNSZones(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "azure_network_privatednszones",
		Description: "Azure Network PrivateDNSZones",
		...
		Columns: azureOGColumns([]*plugin.Column{
			{
				...
				Transform:   transform.FromField("Description.PrivateDNSZones.Properties.Subscription"),
			},
			{
				Name:        "id",
				Description: "The id of the privatednszones.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.PrivateDNSZones.ID")},
			{
				Name:        "name",
				Description: "The name of the privatednszones.",
				Type:        proto.ColumnType_STRING,
